        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 gap-y-4 gap-x-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 justify-items-center">
            {[
              ...
              <div key={index} className="flex flex-col overflow-hidden transition-all duration-300 ease-in-out transform rounded-lg shadow-lg hover:scale-105" style={{ width: '280px', margin: '15px 15px 15px 15px'}}>
