    ...
    <div className="bg-gray-50">
      ...
      <section className="relative flex items-center justify-center h-screen overflow-hidden bg-center bg-cover">
        ...
        <div className="relative z-10 max-w-4xl px-4 mx-auto text-center">
          <h1 className="mb-6 text-5xl font-bold text-white md:text-7xl animate-slide-down">Welcome to CodeInc</h1>
          <p className="mb-10 text-xl text-gray-200 md:text-2xl animate-slide-up">Empowering Your IT Career Journey</p>
          <a href="#internships" className="px-8 py-3 text-lg font-semibold text-white transition duration-300 ease-in-out transform bg-blue-600 rounded-full hover:bg-blue-700 hover:scale-105 animate-bounce-subtle">Explore Internships</a>
        </div>
      </section>
