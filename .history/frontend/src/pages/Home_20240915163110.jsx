    ...
    <div className="bg-gray-50">
      ...
      <section className="relative flex items-center justify-center h-screen overflow-hidden bg-center bg-cover">
        ...
        <div className="relative z-10 max-w-4xl px-4 mx-auto text-center">
          <h1 className="mb-6 text-5xl font-bold text-white opacity-0 md:text-7xl animate-fade-in-down">Welcome to CodeInc</h1>
          <p className="mb-10 text-xl text-gray-200 opacity-0 md:text-2xl animate-fade-in-up">Empowering Your IT Career Journey</p>
          <a 
            href="#internships" 
            className="inline-block px-8 py-3 text-lg font-semibold text-white transition duration-300 ease-in-out transform bg-blue-600 rounded-full opacity-0 hover:bg-blue-700 hover:scale-105 animate-fade-in"
          >
            Explore Internships
          </a>
        </div>
