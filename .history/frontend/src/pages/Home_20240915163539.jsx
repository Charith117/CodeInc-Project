    ...
    <div className="bg-gray-50">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto">
          <h2 className="mb-8 text-2xl font-semibold text-center text-gray-800">Internship Fields</h2>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {['Web Development', 'Mobile App Development', 'Data Science', 'Cloud Computing', 'Cybersecurity', 'Artificial Intelligence'].map((field, index) => (
              <div key={index} className="p-4 transition-colors duration-300 border border-gray-200 rounded-md hover:bg-gray-50">
                <h3 className="mb-2 text-lg font-medium text-gray-700">{field}</h3>
                <p className="text-sm text-gray-600">Experience {field.toLowerCase()} technologies.</p>
              </div>
            ))}
          </div>
        </div>
