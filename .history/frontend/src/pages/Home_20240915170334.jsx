    ...
    <div className="bg-gray-50">
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto">
          <h2 className="mb-8 text-4xl font-bold text-center text-gray-800 animate-fade-in">Explore Our Internship Fields</h2>
          <div className="grid grid-cols-1 gap-y-6 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 justify-items-center">
            {[
              ...
              <div 
                key={index} 
                className="flex flex-col overflow-hidden transition-all duration-500 ease-in-out transform rounded-lg shadow-lg hover:scale-105" 
                style={{ 
                  width: '320px', 
              ...
              >
                <img src={field.image} alt={field.title} className="object-cover w-full h-56" />
