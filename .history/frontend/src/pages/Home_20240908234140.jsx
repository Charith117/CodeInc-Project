...
function Home() {
  ...
  return (
    <div className="container mx-auto">
      {/* Banner Section */}
      <section className="relative h-[80vh] w-[100vw] flex items-center justify-center bg-cover bg-center ml-0" style={{backgroundImage: "url('/path/to/your/beautiful-banner-image.jpg')"}}>
        <div className="absolute inset-0 bg-black opacity-50"></div>
        <div className="container mx-auto text-center relative z-10">
          <h1 className="text-6xl font-bold mb-6 text-white leading-tight">Welcome to CodeInc</h1>
          <p className="text-2xl text-white mb-8">Empowering Your Digital Journey</p>
          <a href="#services" className="bg-blue-600 text-white py-3 px-8 rounded-full text-lg font-semibold hover:bg-blue-700 transition duration-300 ease-in-out">Explore Our Services</a>
        </div>
      </section>
