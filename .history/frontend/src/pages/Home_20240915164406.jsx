    ...
    <div className="bg-gray-50">
      ...
      <section className="py-12 bg-gray-100">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 justify-items-center">
            {[
              ...
              <div key={index} className="flex flex-col overflow-hidden bg-white rounded-lg shadow-lg" style={{ width: '200px' }}>
                <img src={field.image} alt={field.title} className="object-cover w-full h-32" />
                <div className="flex flex-col justify-between flex-grow p-4">
                  <div>
                    <h3 className="mb-2 text-base font-semibold">{field.title}</h3>
                  ...
                  <div className="flex justify-center mt-4">
                    <a 
                      ...
                      className="px-3 py-1 text-xs font-semibold text-white transition-colors duration-300 bg-blue-600 rounded hover:bg-blue-700"
                    >
                      Apply Now
                    </a>
                  </div>
