      ...
      <section className="py-16">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 gap-y-10 gap-x-8 sm:grid-cols-2 lg:grid-cols-3 justify-items-center">
            {[
              { title: 'Web Development', image: 'https://assets.zyrosite.com/Aq20eV79zLfpXV6b/data-science-2-mP4XPq0y3wUKory9.gif', description: 'Build responsive and dynamic websites using modern frameworks.' },
              ...
              >
                <img src={field.image} alt={field.title} className="object-cover w-full h-64 rounded-[100px]" />
                <div className="flex flex-col justify-between flex-grow p-6">
                  <div>
                    <h3 className="mb-4 text-3xl font-semibold animate-text-slide-up">{field.title}</h3>
                    <p className="text-lg text-gray-600 animate-text-fade-in">{field.description}</p>
                  </div>
                  <div className="flex justify-center mt-8">
                    <a 
                      ...
                      className="px-8 py-4 text-lg font-semibold text-white transition-all duration-300 transform bg-blue-600 rounded-full hover:bg-blue-700 hover:shadow-lg hover:scale-105"
                    >
                      Apply Now
                    </a>
                  </div>
