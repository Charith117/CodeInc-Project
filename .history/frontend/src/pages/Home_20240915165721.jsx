    ...
    <div className="bg-gray-50">
      ...
      <section className="py-12 bg-gray-100">
        <div className="container mx-auto">
          <h2 className="mb-6 text-3xl font-bold text-center text-gray-800 animate-fade-in">Explore Our Internship Fields</h2>
          <div className="grid grid-cols-1 gap-y-4 gap-x-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 justify-items-center">
            {[
              ...
              <div key={index} className="flex flex-col overflow-hidden transition-all duration-300 ease-in-out transform rounded-lg shadow-lg hover:scale-105 animate-fade-in" style={{ width: '280px', margin: '15px 15px 15px 15px', animationDelay: `${index * 0.1}s` }}>
                <img src={field.image} alt={field.title} className="object-cover w-full h-48" />
                <div className="flex flex-col justify-between flex-grow p-5">
                  ...
                  <div className="flex justify-center mt-5">
                    <a 
                      ...
                      className="px-5 py-2 text-sm font-semibold text-white transition-all duration-300 transform bg-blue-600 rounded-full hover:bg-blue-700 hover:shadow-lg hover:scale-105"
                    >
                      Apply Now
                    </a>
                  </div>
