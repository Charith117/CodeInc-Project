        ...
        <div className="container mx-auto">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={index} className="flex overflow-hidden bg-white rounded-lg shadow-lg">
                <img src={field.image} alt={field.title} className="object-cover w-1/4 h-32" />
                <div className="flex flex-col justify-between flex-grow p-4">
                  ...
                  <a 
                    ...
                    className="self-start px-3 py-1 mt-2 text-sm font-semibold text-white transition-colors duration-300 bg-blue-600 rounded hover:bg-blue-700"
                  >
                    Apply Now
                  </a>
                </div>
