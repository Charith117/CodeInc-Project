          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div key={index} className="overflow-hidden bg-white rounded-lg shadow-lg">
                ...
                <div className="p-6">
                  <h3 className="mb-2 text-xl font-semibold">{field.title}</h3>
                  <p className="mb-4 text-gray-600">{field.description}</p>
                  <a 
                    href="https://forms.google.com/internship-application" 
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="inline-block px-4 py-2 font-semibold text-white transition-colors duration-300 bg-blue-600 rounded hover:bg-blue-700"
                  >
                    Apply Now
                  </a>
                </div>
