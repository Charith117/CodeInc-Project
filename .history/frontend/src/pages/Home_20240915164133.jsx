        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            {[
              ...
              <div key={index} className="flex flex-col overflow-hidden bg-white rounded-lg shadow-lg h-80">
          ...
          <div className="mt-8 text-center">
            <a 
              ...
              className="inline-block px-6 py-2 text-sm font-semibold text-white transition-colors duration-300 bg-blue-600 rounded-full hover:bg-blue-700"
            >
              Apply Now
            </a>
          </div>
