        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            {[
              ...
              <div key={index} className="flex flex-col overflow-hidden bg-white rounded-lg shadow-lg">
                ...
                <div className="flex flex-col justify-between flex-grow p-4">
                  ...
                  <a 
                    ...
                    className="self-start px-3 py-1 mt-4 text-sm font-semibold text-white transition-colors duration-300 bg-blue-600 rounded hover:bg-blue-700"
                  >
                    Apply Now
                  </a>
                </div>
