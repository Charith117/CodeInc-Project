      ...
      {/* Banner Section */}
       <section className="relative h-[80vh] w-full flex items-center justify-center bg-cover bg-center" style={{backgroundImage: "url('/path/to/your/beautiful-banner-image.jpg')"}}>
        ...
        <div className="w-full text-center relative z-10">
          <h1 className="text-7xl font-bold mb-6 text-yellow-400 leading-tight font-serif">Welcome to CodeInc</h1>
          <p className="text-4xl text-green-300 mb-8 font-sans">Empowering Your Digital Journey</p>
