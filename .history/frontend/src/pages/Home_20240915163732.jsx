    ...
    <div className="bg-gray-50">
      ...
      <section className="py-16">
        <div className="container mx-auto">
          <h2 className="mb-8 text-2xl text-center">Internship Fields</h2>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {['Web Development', 'Mobile App Development', 'Data Science', 'Cloud Computing', 'Cybersecurity', 'Artificial Intelligence'].map((field, index) => (
              <div key={index} className="p-4 border">
                <h3 className="mb-2 text-lg">{field}</h3>
                <p className="text-sm">Experience {field.toLowerCase()} technologies.</p>
              </div>
            ))}
          </div>
        </div>
