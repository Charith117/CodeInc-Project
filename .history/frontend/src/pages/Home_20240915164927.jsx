    ...
    <div className="bg-gray-50">
      ...
      <section className="py-12 bg-gray-100">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 gap-y-2.5 gap-x-2.5 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 justify-items-center  bg-red-500 ">
            {[
              ...
              <div key={index} className="flex flex-col overflow-hidden bg-gray-100 rounded-lg shadow-lg" style={{ width: '250px' }}>
