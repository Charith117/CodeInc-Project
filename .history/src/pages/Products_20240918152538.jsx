    ...
    return (
      <div className="container mx-auto mt-8">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <div className="max-w-sm m-4 overflow-hidden bg-white rounded shadow-lg">
            <img className="object-cover w-full h-48" src="https://assets.zyrosite.com/Aq20eV79zLfpXV6b/web_developing-dJoGejvV7nI9KNlO.gif" alt="Web Development Project"/>
            <div className="px-6 py-4">
              <div className="mb-2 text-xl font-bold">Web Development Project</div>
              <p className="text-base text-gray-700">
                Build responsive and dynamic websites using modern frameworks.
              </p>
            </div>
          </div>
          <div className="max-w-sm m-4 overflow-hidden bg-white rounded shadow-lg">
            <img className="object-cover w-full h-48" src="https://assets.zyrosite.com/Aq20eV79zLfpXV6b/mob-dev-AGBrMO8XElc08jln.gif" alt="Mobile App Development Project"/>
            <div className="px-6 py-4">
              <div className="mb-2 text-xl font-bold">Mobile App Development Project</div>
              <p className="text-base text-gray-700">
