  ...
  return (
    <div className="bg-gray-50">
      ...
      <section className="relative flex items-center justify-center h-screen overflow-hidden bg-center bg-cover">
        <div className="absolute inset-0 bg-center bg-cover animate-ken-burns" style={{backgroundImage: "url('https://assets.zyrosite.com/Aq20eV79zLfpXV6b/web_developing-dJoGejvV7nI9KNlO.gif')"}}></div>
