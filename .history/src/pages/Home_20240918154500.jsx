  ...
  return (
    <div className="bg-gray-50">
      ...
      <nav className="flex items-center justify-between px-4 py-2 bg-white shadow-md">
        <div className="text-xl font-semibold text-gray-800">CodeInc</div>
        ...
        <div className="hidden md:flex">
          <a href="#" className="px-4 py-2 text-gray-800">Home</a>
          <a href="#" className="px-4 py-2 text-gray-800">About Us</a>
          <a href="#" className="px-4 py-2 text-gray-800">Internships</a>
          <a href="#" className="px-4 py-2 text-gray-800">Community</a>
          <a href="#" className="px-4 py-2 text-gray-800">Contact</a>
        </div>
      </nav>
        ...
        <div className="container mx-auto" style={{ width: '80%' }}>
          ...
          <div className="grid grid-cols-1 gap-y-10 gap-x-8 sm:grid-cols-2 lg:grid-cols-3 justify-items-center">
            {[
              ...
              { title: 'Data Science', image: 'https://assets.zyrosite.com/Aq20eV79zLfpXV6b/data-science-2-mP4XPq0y3wUKory9.gif', description: 'Analyze complex datasets and derive meaningful insights.' },
              { title: 'Cloud Computing', image: 'https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=227,h=168,fit=crop/Aq20eV79zLfpXV6b/java_projects_for_beginners-AGBrMZgjljfZV2EE.jpg', description: 'Harness the power of cloud technologies for scalable solutions.' },
              { title: 'Cybersecurity', image: 'https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=227,h=168,fit=crop/Aq20eV79zLfpXV6b/istock-1276643671-A1agppkaKqi8zzvj.jpg', description: 'Protect digital assets and implement robust security measures.' },
              { title: 'Artificial Intelligence', image: 'https://assets.zyrosite.com/Aq20eV79zLfpXV6b/9d7b99_dfcb8e88751c4cecb7ac677976976ec8~mv2-mP4Xa8xEPPTLEoVx.gif', description: 'Develop intelligent systems and machine learning models.' }
            ].map((field, index) => (
              <div 
                key={index} 
