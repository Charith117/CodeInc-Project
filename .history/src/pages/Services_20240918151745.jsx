    ...
    return (
      <div className="container p-4 mx-auto mt-8 bg-gray-100 rounded-lg shadow-lg">
        ...
        <div className="grid grid-cols-1 gap-y-10 gap-x-8 sm:grid-cols-2 lg:grid-cols-3 justify-items-center">
          <div className="flex flex-col items-center p-4 space-y-2 bg-blue-500 rounded-lg" style={{ width: '320px', height: '420px' }}>
          ...
          <div className="flex flex-col items-center p-4 space-y-2 bg-green-500 rounded-lg" style={{ width: '320px', height: '420px' }}>
            <div className="flex flex-col items-center space-y-2">
              <div className="overflow-hidden h-96">
                <img src="https://assets.zyrosite.com/Aq20eV79zLfpXV6b/mob-dev-AGBrMO8XElc08jln.gif" alt="Mobile App Development" className="object-cover w-full h-full rounded-lg" />
              </div>
              <div className="p-4">
          ...
          <div className="flex flex-col items-center p-4 space-y-2 bg-yellow-500 rounded-lg" style={{ width: '320px', height: '420px' }}>
            <div className="flex flex-col items-center space-y-2">
              <div className="overflow-hidden h-96">
                <img src="https://cdn.pixabay.com/photo/2017/08/07/13/45/design-2595514_960_720.jpg" alt="UI/UX Design" className="object-cover w-full h-full rounded-lg" />
              </div>
              <div className="p-4">
          ...
          <div className="flex flex-col items-center p-4 space-y-2 bg-red-500 rounded-lg" style={{ width: '320px', height: '420px' }}>
            <div className="flex flex-col items-center space-y-2">
              <div className="overflow-hidden h-96">
